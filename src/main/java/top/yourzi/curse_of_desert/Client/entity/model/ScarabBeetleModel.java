...
import top.yourzi.curse_of_desert.Entities.ScarabBeetle.ScarabBeetleAnimation;

public class ScarabBeetleModel<T extends Entity> extends HierarchicalModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "textures/entity/scarab"), "main");
