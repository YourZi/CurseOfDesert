...
import top.yourzi.curse_of_desert.Entities.client.animation.MummyAnimation;
...
public class MummyModel<T extends Entity> extends HierarchicalModel<T>{
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition itemr = arm_right.addOrReplaceChild("itemr", CubeListBuilder.create(), PartPose.offset(0.0F, 10.0F, 0.0F));
		...
		PartDefinition iteml = arm_left.addOrReplaceChild("iteml", CubeListBuilder.create(), PartPose.offset(0.0F, 9.0F, 0.0F));
