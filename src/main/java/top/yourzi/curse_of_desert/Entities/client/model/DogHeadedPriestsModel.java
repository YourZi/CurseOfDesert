...
import top.yourzi.curse_of_desert.Entities.client.animation.DogHeadedPriestsAnimation;
...
public class DogHeadedPriestsModel<T extends Entity> extends HierarchicalModel<T>{
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = right_hand.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(60, 0).addBox(-0.5F, -10.0F, -0.5F, 1.0F, 14.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(52, 13).addBox(-3.5F, -10.0F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(46, 9).addBox(-5.5F, -10.0F, -0.5F, 2.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, -0.5F, 1.5708F, 0.0F, -1.5708F));
